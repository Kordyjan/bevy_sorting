...
/// the first read
#[must_use] pub fn write_before_read<T: 'static>() -> NodeConfigs<Interned<dyn SystemSet>> {
...
#[must_use] pub fn read_before_write<T: 'static>() -> NodeConfigs<Interned<dyn SystemSet>> {
